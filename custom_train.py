"""
自定义训练脚本 - 使用虚拟数据调通 RegistrationNet 流程
用于测试和调试网络结构
"""
...
from liftreg.training.regUNetTrainer.regUNetTrainer import regUNetTrainer
from liftreg.utils.general import make_dir
from liftreg.utils import module_parameters as pars

from stat import S_IREAD
from liftreg.utils.general import get_git_revisions_hash, make_dir
