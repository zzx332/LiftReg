...
def main():
    ...
    model_name = "polypose"
    output_dir = rf'/home/zzx/data/data/test_shift_only_06'
    num_frames = 10
    for subject_id in range(6, 7):
        ...
        if model_name == "polypose":
            img, mask = fit_polypose(gt, poses, volume, mask, output_dir, num_frames, KWARGS, subject_id)
